...
public class CtrlAlterarUsuario implements ICtrlAlterarUsuario {
	...
	/*
	 * @Override public Usuario incluirUsuario(Usuario novo)throws ModelException,
	 * ControllerException { try { System.out.println("incluindo usuario"); } catch
	 * (Exception e) { // TODO Auto-generated catch block e.printStackTrace(); }
	 * DaoUsuario dao = new DaoUsuario(); dao.incluirUsuario(novo);
	 * 
	 * HttpSession sessao = request.getSession(true);
	 * sessao.setAttribute("contaLogada", novo); return novo; }
	 */
